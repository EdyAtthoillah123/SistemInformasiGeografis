            ...
            view.on("click", function(event) {
                ...
                view.hitTest(screenPoint).then(function(response) {
                    ...
                    if (result) {
                        ...
                        // Membuat simbol untuk ikon marker
                        var markerSymbol = new SimpleMarkerSymbol({
                            color: [255, 0, 0],
                            size: "16px", // Ukuran ikon
                            outline: {
                                color: [255, 255, 255],
                                width: 2
                            }
                        ...
                        // Membuat grafik dengan simbol dan koordinat lokasi
                        ...
                        // Menambahkan grafik ke layer grafik peta
...
<body>
    <div class="container-fluid">
        <div class="row">
                ...
                {{-- <div class="legend-container" id="layerSelector">
                    ...
                    <label>
                        <p class="layer-checkbox">
                            ...
                            <span class="layer-label" style="margin-top: 8px;">Badan Air</span>
                        </p>
                    </label>
                </div> --}}
            ...
            {{-- <h6>Zona Ruang Terbuka Hijau</h6>
            <p>Sub Zona RTH Tanman Kecamatan</p>
            <p>Sub Zona RTH Taman Kelurahan</p>
            <p><img src="{{ asset('image/DotMakamGresik.png') }}" alt="Icon" class="icon-img"> Sub Zona RTH
                Pemakaman</p>
            <p>Sub Zona RTH Jalur Hijau</p>
            <h6>Zona Badan Jalan</h6>
            <P><img src="{{ asset('image/Jalan.png') }}" alt="Icon" class="icon-img"> Zona Badan Jalan
            </P>
            <h6>Zona Perumahan</h6>
            <p>Sub Zona Perumahan Kepadatan Tinggi</p>
            <p>Sub Zona Kepadatan Sedang</p>
            <h6>Zona Perdagangan dan Jasa</h6>
            <p>Sub Zona Perdagangan dan Jasa Skala Kota</p>
            <p>Sub Zona Perdagangan dan Jasa Skala SWP</p>
            <h6>Zona Perkantoran</h6>
            <p><img src="{{ asset('image/PerkantoranGresik.png') }}" alt="Icon" class="icon-img"> Zona
                Perkantoran</p>
            <h6>Zona Kawasan Peruntukan Industri</h6>
            <p>Zona Kawasan Peruntukan Industri</p>
            <h6>Zona Sarana Pelayanan Umum</h6>
            <p>Sub Zona Skala Kota</p>
            <p>Sub Zona Skala Kecamatan</p>
            <p>Sub Zona Skala Kelurahan</p>
            <h6>Zona Pembangkitan Tenaga Listrik</h6>
            <p><img src="{{ asset('image/DotListrik.png') }}" alt="Icon" class="icon-img"> Zona
                Pembangkitan
                Tenaga Listrik</p>
            <h6>Zona Pertanian</h6>
            <p>Sub Zona Pertanian Tanaman Pangan</p> --}}
            {{-- <div id="layerSelector">
                <h5>Layer Selector</h5>
                <label>
                    <input type="checkbox" name="layer" value="geojsonLayer1" checked> GeoJSON Layer 1
                </label>
                <br>
                <label>
                    <input type="checkbox" name="layer" value="geojsonLayer2" checked> GeoJSON Layer 2
                </label>
                <br>
                <label>
                    <input type="checkbox" name="layer" value="geojsonLayer3" checked> GeoJSON Layer 3
                </label>
                <br>
                <!-- Add more checkboxes for other GeoJSON layers -->
                <label>
                    <input type="checkbox" name="layer" value="graphicLayer" checked> Graphic Layer
                </label>
            </div> --}}
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel" style="color: rgb(255, 72, 0);   ">
                        Penjelasan dan Ketentuan</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <h5 class="fw-light">Penggunaan data dan informasi dalam situs ini sebagai basis
                        perizinan dan dokumen
                        resmi lainnya sangat tidak disarankan. Informasi yang dapat digunakan dalam
                        perizinan tetap mengacu pada instansi/lembaga yang berwenang.</h5>
                </div>
